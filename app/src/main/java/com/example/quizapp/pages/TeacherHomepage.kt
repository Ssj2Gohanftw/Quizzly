...
import com.example.quizapp.components.TrQuizCard
import com.example.quizapp.components.TrQuizDetailDialog
...
fun TrHomePage(
    ...
    LaunchedEffect(searchQuery) {
        filteredQuizList = quizList.filter { quiz ->
            quiz.name.contains(searchQuery, ignoreCase = true) || quiz.topic.contains(
                searchQuery,
                ignoreCase = true
            )
        }
